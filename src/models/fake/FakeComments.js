...
export default function fakeComments(number) {
  console.warn(
    "WARNING!!",
    "Calling fakeComments! Are you still testing? If not then please call appropriate function."
  );
  var arr = [];
  ...
  for (var i = 0; i < number; i++) {
    ...
    var obj = {
      fromId: id,
      toId: id === 0 ? 1 : 0,
      messageId: "comment_id_" + i,
      message: randomWords(5, 80, "c"),
